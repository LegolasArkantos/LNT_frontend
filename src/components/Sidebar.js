...
const Sidebar = (props) => {
  ...
  return (
    <aside
      id="default-sidebar"
      className="fixed top-0 left-0 z-40 transition-transform -translate-x-0 sm:translate-x-0"
      aria-label="Sidebar"
    >
      <div className=" bg-blue-100 dark:bg-gray-800">
        <ul className="h-screen relative flex flex-col justify-center space-y-5 font-medium">
          <li>
            <Link
              to="/home-page"
