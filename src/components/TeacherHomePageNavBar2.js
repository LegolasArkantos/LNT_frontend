...
const TeacherHomePageNavBar2 = () => {
  ...
  return (
    <nav className="fixed top-16 w-full z-20">
        ...
        <ul className="relative flex font-medium w-screen">
          <li>
            <Link
              ...
              className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white group ${
                location.pathname === "/teacher-home-page"
          ...
          <li>
            <Link
              to="chats"
              className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white group ${
                location.pathname === "/teacher-home-page/chats"
                  ? "text-white underline"
                  : "hover:text-white"
              }`}
            >
...
<div id="toast-notification" class="w-full max-w-xs p-4 text-gray-900 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-300" role="alert">
    ...
    <div class="flex items-center">
        ...
        <div class="ms-3 text-sm font-normal">
            <div class="text-sm font-semibold text-gray-900 dark:text-white">{notification.title}</div>
...
export default TeacherHomePageNavBar2;
