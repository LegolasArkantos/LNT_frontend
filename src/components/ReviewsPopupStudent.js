...
const ReviewsPopupStudent = ({setReviewPopUp, reviewPopUpData}) => {
  ...
  return (
    ...
    <h1 onClick={() => setReviewsSelected(true)} className={`text-xl ${reviewsSelected ? 'text-[#7179C6]' : 'text-gray-400' }  cursor-pointer font-bold`}>Reviews</h1>
    <h1 onClick={() => setReviewsSelected(false)} className={`text-xl ${!reviewsSelected ? 'text-[#7179C6]' : 'text-gray-400' } cursor-pointer font-bold`}>Create Review</h1>
    </div>
    {
        reviewsSelected 
        ? (
    ...
    <hr/>
        ...
        (
          ...
          <label for="rating" class="block mb-2 text-sm font-medium text-purple-800">Rating</label>
          <div id="rating" class="flex items-center  mb-5">
            {stars.map((star, index) => (
              ...
              <div class="flex flex-col">
                  <label for="description" class="block mb-2 text-sm font-medium text-purple-800">Description</label>
          ...
          <button type="submit" class="bg-[#7179C6] hover:bg-purple-800 text-white px-4 py-2 rounded">
              Submit
          </button>
          </div>
      </form>
