...
const ReviewsPopup = ({setReviewPopUp}) => {
  ...
  return (
    ...
    <div className='rounded bg-teal-100 overflow-hidden w-3/4 h-3/4'>
    <ul className=' p-5 h-full space-y-5 overflow-y-scroll scrollbar-hide scroll'>
        <li>
    <div class="flex items-center mb-4">
        <img class="w-10 h-10 me-4 rounded-full" src="/docs/images/people/profile-picture-5.jpg" alt=""></img>
