        ...
        >
          <ul class="flex flex-col text-xl font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-teal-300 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-teal-300 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <Link
                ...
                className={`block py-2 px-3 rounded md:bg-transparent  md:p-0 ${(location.pathname !== "/teacher-career-page/career" && location.pathname !== "/teacher-career-page/careerSignup") ? 'text-blue-700' : 'text-gray-900'}`}
                aria-current="page"
              >
                Learn
              </Link>
            ...
            <li>
            <Link
                className={`block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 ${location.pathname == "/teacher-career-page/career" || location.pathname == "/teacher-career-page/careerSignup" ? 'text-blue-700' : 'text-gray-900'}`}
