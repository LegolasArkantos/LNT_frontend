...
const TeacherSessionsPage = () => {
  ...
  return (
    ...
    <div style={{ backgroundColor: '#f0f0f0' }}>  
        <div style={{ backgroundColor: '#f0f0f0' }} className="flex h-screen ">

            {/* Main Content */}
            <div className="p-8 flex space-x-8 h-full">
              {/* Sessions Container */}
              <div className="rounded bg-white p-8 flex-1 h-screen-1/2 overflow-y-auto mb-[120px]">
              ...
              <div className="rounded bg-white p-8 flex-1 h-screen-1/3 overflow-y-auto mt-[-50px] mb-[120px]">
