...
const VideoCallPage2 = () => {
    ...
    const leaveStream = async () => {
        ...
        if (userType === "Teacher") {
            ...
            if (purpose === "Session") {
                ...
                navigate('/student-career-page/my-counselors');
            }
        }
  ...
  return (
        <div className='flex space-x-10 p-2 w-full items-center justify-center bg-gray-300 overflow-y-scroll scroll scrollbar-hide h-screen w-screen'>
    ...
    <div className='flex-col h-full w-full'>
        ...
        <div className='flex justify-end font-bold'>
            ...
            <div className='flex items-center justify-center'>
             <div class="inline-flex rounded-md z-20 shadow-sm" role="group">
               {
                !screenShare && (
                 <button onClick={() => toggleCamera()}  className={`inline-flex items-center px-4 py-2 mt-4 text-sm font-medium text-white ${camera ? 'bg-purple-500' : 'bg-white'} hover:bg-purple-500 rounded-s-lg  focus:outline-none focus:ring-2 `}>
               ...
               <button onClick={() => toggleMic()} className={`inline-flex items-center px-4 py-2 mt-4 text-sm font-medium text-white ${mic ? 'bg-purple-500' : 'bg-white'} hover:bg-purple-500 focus:outline-none focus:ring-2 `}>
               ...
               <button onClick={() => toggleScreen()}  className={`inline-flex items-center px-4 py-2 mt-4 text-sm font-medium text-white ${screenShare ? 'bg-purple-500' : 'bg-white'} hover:bg-purple-500 focus:outline-none focus:ring-2 `}>
               ...
               <button onClick={() => leaveStream()} className="inline-flex items-center px-4 py-2 mt-4 text-sm font-medium text-white bg-purple-500 rounded-e-lg hover:bg-purple-600 focus:outline-none focus:ring-2">
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <div className='flex-col outline outline-gray-400 h-4/5 flex-1 bg-gray-200 overflow-y-scroll scroll scrollbar-hide rounded outline outline-teal-700 p-5 space-y-5'>
               {
                 remoteUsers && (
