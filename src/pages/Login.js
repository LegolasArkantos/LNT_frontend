          ...
          <form class="max-w-sm mx-auto pt-5" onSubmit={submit}>
            ...
            <div class="mb-2">
              ...
              <input
                ...
                class="bg-gray-50 mb-2 border border-[#7179C6] text-gray-900 text-sm rounded-lg focus:ring-[#7179C6] focus:border-[#7179C6] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="•••••••••"
                required
              />
            </div>
            <div className="flex justify-end mb-3">
            <p onClick={() => navigate("/forgot-password")} className="text-[#7179C6] font-semibold text-sm cursor-pointer hover:underline">
            forgot password?
            </p>
            </div>
