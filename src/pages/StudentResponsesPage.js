...
const StudentResponsesPage = () => {
  ...
  const handleSubmissionClick = (assignmentId, marks) => {
    console.log("id dad "+assignmentId,"id dad "+ marks)
    navigate('/teacher-home-page/submissons', { state: { assignmentId,marks} });
  };
  ...
  return (
    <div className="p-8">
      ...
      <button 
      type="button" 
      onClick={() =>handleSubmissionClick(assignmentId,assignment.marks)} 
