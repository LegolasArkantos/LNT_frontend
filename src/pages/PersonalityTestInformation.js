  ...
  return (
    <div className='w-screen h-screen'>
        ...
        {/* <button
          ...
          <button
            type="button"
            className="text-white bg-[#7179C6]  cursor-pointer hover:bg-purple-500 focus:ring-4 focus:outline-none focus:ring-purple-500 font-medium rounded-lg text-sm w-[100px] px-5 py-2.5 text-center"
            onClick={
                () => {
                    navigate("/signup3", {
                        state: {
        ...
        <div className='mt-12 w-1/5 h-[200px] shadow p-3 flex bg-gray-100 items-center justify-center'>
            <div>
        ...
        <div className='mt-12 w-1/5 h-[200px] shadow flex bg-gray-100 items-center justify-center'>
            <div>
            ...
            <div>
              <div className='flex items-center justify-center'>
            <p className='pl-1 pr-1 text-center'>
        ...
        <div className='mt-12 w-1/5 h-[200px] shadow p-1 flex bg-gray-100 items-center justify-center'>
            <div>
            <div className='flex justify-center mb-2 items-center'>
