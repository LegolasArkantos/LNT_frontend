...
import contactustopimage from '../assets/contactustopimage.png';
import contactusimage2 from '../assets/contactusimage2.png';

const ContactUsPage = () => {
  return (
    <div className='relative flex flex-col w-full'>
        <img className='h-[250px]' src={contactustopimage}/>
        <div className='absolute top-32 right-36 flex flex-col mb-5'>
            <h className='text-3xl text-center font-bold text-white' >
              Contact Us
            </h>
          ...
          <h className='text-3xl text-center mt-5 font-bold justify-between' >
          Get in Touch with Learn and Track!
            </h>
            ...
            <p className='text-sm text-gray-700 font-semibold' >
            on your learning adventure. Whether you're a
            </p>
            <p className='text-sm text-gray-700 font-semibold' >
            student seeking the perfect tutor or simply curious
            </p>
            <p className='text-sm text-gray-700 font-semibold' >
